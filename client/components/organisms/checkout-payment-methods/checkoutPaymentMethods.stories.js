...
import CheckoutPaymentMethods from './index.vue';
...
// stories
storiesOf('Organisms/Checkout Payment Methods', module)
  .add('default', () => ({
    data() {
      return {
        paymentMethods,
      ...
      <container class="py-6">
        <row>
          <column class="w-full lg:w-7/12">
            <checkout-payment-methods :payment-methods="paymentMethods"/>
          </column>
        </row>
      </container>
      `,
